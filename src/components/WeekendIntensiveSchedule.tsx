...
export default function WeekendIntensiveSchedule({
  ...
  return (
    <div className="overflow-hidden rounded-xl bg-[#2b2150]">
      <button
        onClick={() => setOpen(!open)}
        className="group flex w-full items-center gap-4 p-5 text-left transition-colors hover:bg-[#332661]"
      >
        ...
        <div className="flex-1">
          <h3 className="text-base font-bold text-white transition-colors group-hover:text-violet-light">Weekend Intensive Schedule</h3>
