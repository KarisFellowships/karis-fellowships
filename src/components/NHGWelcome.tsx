            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl bg-white/[0.04] p-5">
                <div className="flex items-center gap-3 rounded-xl bg-gradient-to-br from-violet to-[#c084fc] px-4 py-3 shadow-md shadow-violet/30">
                  <span className="font-serif text-2xl font-bold leading-none text-white">1</span>
                ...
                <a href={AMAZON_URL} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center gap-2 rounded-lg bg-teal/20 px-4 py-2 text-xs font-semibold text-teal-light transition-all hover:bg-teal/30">
                ...
                <ExpandableSection collapsedLabel="More options">
                  <div className="space-y-2 text-sm leading-[1.8] text-white/70">
                    <ul className="list-disc space-y-1 pl-5">
                      ...
                      <li><a href="https://www.audible.com/pd/Neurosis-and-Human-Growth-Audiobook/B002V8MWUC" target="_blank" rel="noopener noreferrer" className="text-violet-light underline underline-offset-2 decoration-violet-light/30 hover:text-white transition-colors">Audible.com</a> &mdash; audio supplement; first-time members get one audiobook free</li>
                    </ul>
                  </div>
                </ExpandableSection>
              </div>
              ...
              <div className="rounded-xl bg-white/[0.04] p-5">
                <div className="flex items-center gap-3 rounded-xl bg-gradient-to-br from-violet to-[#c084fc] px-4 py-3 shadow-md shadow-violet/30">
                  <span className="font-serif text-2xl font-bold leading-none text-white">2</span>
                  <h3 className="font-serif text-xl font-bold leading-tight text-white sm:text-2xl">Download Syllabus &amp;<br />Start Reading</h3>
                </div>
                <p className="mt-1 text-sm leading-[1.8] text-white/70">
                  You can always find your reading guides in the NHG menu below.
                </p>
                <a href={syllabusUrl} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center gap-2 rounded-lg bg-violet-light/15 px-4 py-2 text-xs font-semibold text-violet-light transition-all hover:bg-violet-light/25">
