...
const card = "flex h-full flex-col rounded-2xl bg-gradient-to-br from-violet to-[#6d28d9] p-6 shadow-lg shadow-violet/25";
const num = "font-serif text-4xl font-bold leading-none text-white/70";
const heading = "font-serif text-2xl font-bold leading-tight text-white";
const body = "mt-3 text-sm leading-relaxed text-white/85";
const bodyLink = "font-semibold text-white underline decoration-white/40 underline-offset-2 transition-colors hover:decoration-white";
const pill = "inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-xs font-bold text-violet transition-all hover:bg-white/90";
              ...
              <div className={card}>
                ...
                <div className="mt-auto pt-5">
                  ...
                  <ExpandableSection collapsedLabel="More options">
                    <div className="space-y-2 text-sm leading-[1.8] text-white/85">
