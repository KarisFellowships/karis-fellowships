    ...
    <>
      ...
      <section className="px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid items-start gap-12 lg:grid-cols-5">
            ...
            <div className="relative lg:col-span-2">
              <div className="relative aspect-[4/3] overflow-hidden rounded-3xl shadow-lg">
                <Image src="/waterfall.jpg" alt="Serene nature" fill className="object-cover" />
              </div>
              <div className="absolute -bottom-4 -right-4 -z-10 h-full w-full rounded-3xl bg-sage-muted" />
            </div>
          </div>

          {/* Vision */}
          <div className="mt-20">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-sage">Our Vision</p>
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              {[
                ...
                <div key={title} className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-border/30">
          ...
          {/* Express Glory */}
          <div className="mt-16 overflow-hidden rounded-3xl bg-gradient-to-r from-gold-light via-gold-light/50 to-cream p-8 sm:p-10">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-gold-hover">Express Your Unique</p>
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={name} className="rounded-2xl bg-white p-7 shadow-sm ring-1 ring-border/30">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-foreground/65">{bio}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* 501c3 */}
          <div className="mt-14 rounded-2xl bg-cream-dark/70 p-7 text-sm leading-relaxed text-foreground/60">
