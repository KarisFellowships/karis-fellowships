...
export default function RegisterClient({ dateInfo }: { dateInfo?: DateInfo | null }) {
  ...
  return (
    <div className="grid items-start gap-10 lg:grid-cols-5 lg:gap-12">
      ...
      {/* LEFT — Date Banner + Registration Form */}
      <div className="lg:col-span-3 space-y-5">

        {dateInfo && (
          <div className="flex flex-col gap-4 rounded-2xl border border-teal/20 bg-gradient-to-r from-teal/5 to-transparent px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      {/* RIGHT — Book Image + How to Get Started */}
