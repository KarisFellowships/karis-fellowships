      ...
      <section className="relative z-10">
        <div className="absolute inset-0">
          <Image
            ...
            fill
            className="object-cover object-center brightness-110 saturate-[1.15]"
          />
      ...
      <section className="px-6 pb-12 pt-4">
        <div className="mx-auto max-w-6xl space-y-3">
          ...
          <div className="grid gap-3 lg:grid-cols-3">
            ...
            <div className="flex flex-col justify-center rounded-xl bg-[#1e293b] p-6">
            ...
            <div className="flex flex-col gap-3">
              {/* Meeting Prep Guide */}
              <div className="flex-1 rounded-xl bg-[#1e293b] p-6">
          ...
          <div className="rounded-xl bg-[#1e293b] p-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                ...
                KF{currentLesson.lessonNumber} Questions
              </a>
            </div>
          ...
          <div className="pt-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {recentLessonNumbers.map((n) => {
                const lesson = lessonMap.get(n);
                return (
                  <Link
                    key={n}
                    href={`/kf/meetings/kf${n}`}
                    className="group flex items-center gap-4 rounded-xl bg-[#1e293b] p-4 transition-all hover:bg-[#243044]"
                  >
                    ...
                    <div>
                      ...
                      {lesson && <p className="text-xs text-white/40">{lesson.dateRange}</p>}
                      <p className="text-xs text-white/30">View lesson &rarr;</p>
                    </div>
                  </Link>
                );
              })}
