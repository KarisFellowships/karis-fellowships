...
export default function NHGSchedulesPage() {
  return (
    <div className="min-h-screen bg-[#4a5568]">
      <PageHeader title="Schedules & Reading Guides" subtitle="Study schedules, chapter guides, and study plan options for the NHG book study." accent="amber" image="/path-nature.jpg" imageAlt="Path through nature" />
