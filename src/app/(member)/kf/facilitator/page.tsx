...
export default async function KFFacilitatorPage() {
  ...
  return (
    <div className="min-h-screen bg-[#4a5568]">
      <PageHeader title="Facilitator Resources" subtitle="Everything you need to lead your weekly KF meeting." accent="violet" image="/forest-canopy.jpg" imageAlt="Sunlit forest canopy" payg />
                ...
                <a
                  ...
                  className={`group flex items-center gap-3 rounded-xl p-3 transition-all hover:-translate-y-0.5 ${
                    n === currentLesson
                      ...
                      : "border border-white/10 bg-white/[0.05] backdrop-blur-sm hover:border-white/20 hover:bg-white/[0.09]"
                  }`}
                >
